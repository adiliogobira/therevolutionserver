...
class Quest(JQuest):
    ...
    def onTalk(self, npc, player):
        ...
        htmltext = None
        if npcId == 32034:
            if st.getQuestItemsCount(9966) == 0 :
            ...
            if st.getQuestItemsCount(9966):
                st.takeItems(9966, 1) # TODO: this part must happen when u walk through doors >.<
                st.giveItems(9966, 1)
            ...
            if not st.getQuestItemsCount(9966):
